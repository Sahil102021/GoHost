...
import img1 from "../img/website-security-img.png";
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  Get your website secure with us. All plans include one-click
                  install, 99.9% uptime, 24/7 security monitoring, and an
                ...
                >
                  {[{ count: "1M+", label: "Secure website from Hackers" }].map(
                    (item, index) => (
                      <Box key={index}>
                        <Typography
                          variant="subtitle1"
